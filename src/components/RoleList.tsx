...
// Merged RoleList with comprehensive UI from RoleForm
...
const RoleList: React.FC = () => {
  ...
  // Initialize sample staff data and load roles
  useEffect(() => {
    // Sample staff data
    setStaffList([
      {
  ...
  // Load cached roles and notify expiring roles
  useEffect(() => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!newUserId || !role || !userName) {
      toast.error('User ID, Name and Role are required');
      return;
    }
    ...
    try {
      ...
      const updatedRoles = await fetchAllRoles(businessId);
      setRoles(updatedRoles);
      localforage.setItem(LOCAL_KEY_PREFIX + businessId, updatedRoles);
  ...
  const removeRole = (id: string) => {
    ...
    if (roleToRemove) {
      handleRemove(roleToRemove.userId, roleToRemove.role);
    }
  };
        ...
        <div className="p-4">
          <div className="space-y-2 text-xs">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-gray-600">Assigned: {dayjs(role.assignedDate).format('YYYY-MM-DD')}</span>
            </div>
            
            {role.expiresAt && (
              <div className="flex items-center space-x-2">
                <AlertTriangle className="w-3 h-3 text-gray-400" />
                <span className="text-gray-600">Expires: {dayjs(role.expiresAt).format('YYYY-MM-DD')}</span>
              </div>
            )}
            
            <div className="flex items-center space-x-2">
              <FileText className="w-3 h-3 text-gray-400" />
              <span className="text-gray-600">{role.files?.length || 0} files attached</span>
            </div>
          </div>
  ...
  return (
    <div className="min-h-screen p-4 bg-gray-50">
      <div className="mx-auto max-w-7xl">
            ...
            <div className="p-6 bg-white shadow-lg rounded-xl">
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <button 
                    onClick={() => toast.success('Opening staff schedule...')}
                  ...
                  <button 
                    onClick={() => toast.success('Generating staff report...')}
                  ...
                  <button 
                    onClick={() => toast.success('Opening staff settings...')}
                  ...
                  <div key={staff.id} className="p-4 border rounded-lg bg-green-50">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex gap-2">
                        <button 
                          onClick={() => toast.success('Editing staff member...')}
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button 
                        onClick={() => toast.success('Viewing staff schedule...')}
                      ...
                      <button 
                        onClick={() => toast.success('Assigning task...')}
        ...
        {/* File Management Modal - Using the original FileUploaderModal */}
